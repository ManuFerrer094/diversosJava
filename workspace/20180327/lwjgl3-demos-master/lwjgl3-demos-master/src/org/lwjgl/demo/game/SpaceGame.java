...
public class SpaceGame {
    ...
    private static final int numerotierras = 1;
    ...
    private void createAsteroid() throws IOException {
        WavefrontMeshLoader loader = new WavefrontMeshLoader();
        asteroid = loader.loadMesh("org/lwjgl/demo/game/2piedras2.zip");
     ...
     private void createTierra() throws IOException {
        WavefrontMeshLoader loader = new WavefrontMeshLoader();
        tierra = loader.loadMesh("org/lwjgl/demo/game/ibiza2.zip");         // Cargame el obj
