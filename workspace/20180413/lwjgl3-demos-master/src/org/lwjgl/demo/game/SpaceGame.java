...
public class SpaceGame {
    ...
    private void createAsteroid() throws IOException {
        ...
        System.out.println("La lista de posiciones de los vertices es: "+asteroid.positions.get(3));
            // Listado de objetos:
           // Primero los metro en una matriz de objetos
            Object[] toArray = asteroid.objects.toArray();
            // Y luego saco el primero de los objetos por pantalla
            System.out.println(toArray[0].toString());
            // Ahora contamos el numero de objetos en el archivo
            System.out.println("La cantidad de objetos que hay dentro del archivo es: "+asteroid.objects.size());
